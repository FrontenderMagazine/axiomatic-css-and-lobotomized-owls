...
представляем себе элемент интерфейса, а затем создаем стили для объекта, которые вручную привязываем к разметке.
...
сводя CSS к SS (*Каскадные таблицы стилей к просто
